{ lib, pkgs }:
{
  ...
  config = rec {
    ...
    keybindings =
      let
        controller = "${pkgs.wireplumber}/bin/wpctl";
      in
      lib.mkOptionDefault {
      ...
      commands = [
        {
          ...
          criteria = {
            title = "Alacritty Dropdown";
          };
        }
        {
          command = "floating enable, move position 0 0, move scratchpad";
          criteria = {
            app_id = "foot";
          };
        }
